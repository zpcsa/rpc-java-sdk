...
public final class StringUtils {
     ...
     * @see #join(Object[] array, String sep, String prefix)
     */
    public static String join(@SuppressWarnings("rawtypes") Collection list, String sep) {
     ...
     * @see #join(Object[] array, String sep, String prefix)
     */
    public static String join(@SuppressWarnings("rawtypes") Collection list, String sep, String prefix) {
